...
public final class DbHelper extends SQLiteOpenHelper {
    ...
    public final void onCreate(final SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE bill (id INTEGER PRIMARY KEY, description TEXT not null, amountInCent INT NOT NULL, currency TEXT NOT NULL, fk_trip INTEGER NOT NULL, fk_payer INTEGER NOT NULL, FOREIGN KEY(fk_trip) REFERENCES trip(id), FOREIGN KEY (fk_payer) REFERENCES user(id))");
        ...
        db.execSQL("CREATE TABLE debt (fk_creditor INTEGER NOT NULL, fk_debtor INTEGER NOT NULL, amountInCent int not null, FOREIGN KEY (fk_creditor) REFERENCES user(id), FOREIGN KEY (fk_debtor) REFERENCES user(id), CONSTRAINT pk_debtid PRIMARY KEY (fk_creditor, fk_debtor))");
