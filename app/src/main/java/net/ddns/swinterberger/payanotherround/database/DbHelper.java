...
public final class DbHelper extends SQLiteOpenHelper {
    ...
    public final void onCreate(final SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE bill (id INTEGER PRIMARY KEY, description TEXT not null, amount INTEGER NOT NULL, currency TEXT NOT NULL, fk_trip INTEGER NOT NULL, FOREIGN KEY(fk_trip) REFERENCES trip(id))");
